...
(function ($)
{
    ...
    $.ligerDefaults.Grid = {
        ...
        cssClass: null,                    //类名
        //edit by pt at 2013-03-15 修改取后端数据源名称
        root: 'ret_data',                       //数据源字段名
        record: 'ret_count',                     //数据源记录数字段名
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            gridhtmlarr.push("                </div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'><span class='pcontrol'> <input type='text' size='4' value='1' style='width:20px' maxlength='3' /> / <span id = 'pcontrol_pageCount'></span></span></div>");
            gridhtmlarr.push("                <div class='l-bar-separator'></div>");
            gridhtmlarr.push("                <div class='l-bar-group'>");
        ...
        loadServerData: function (param, clause)
        {
            ...
            var ajaxOptions = {
                ...
                error: function (XMLHttpRequest, textStatus, errorThrown)
                {
                    ...
                    /*
                     * add by pt at 2013-11-05
                     * 添加后台异常捕获
                     */
                    LFT.showErrorMessage(XMLHttpRequest);
        ...
        */
        ...
        _buildPager: function ()
        {
            ...
            if (!p.pageCount) p.pageCount = 1;
            /*
             * add by pt at 2013-0902 解决IE9下执行查询时，pageCount不及时更新的问题
             */
            $('.pcontrol span', g.toolbar).html.ligerDefer($('.pcontrol span', g.toolbar), 10, [p.pageCount]);
            //document.getElementById("pcontrol_pageCount").innerHTML = p.pageCount;
